...
export class SSRDebugGUI {
  constructor(ssrEffect, gui, params = defaultSSROptions) {
    const pane = gui;
    this.pane = gui.addFolder({ title: "SSR" });
    ...
    const generalFolder = this.pane.addFolder({ title: "General" });
    ...
    const maximumValuesFolder = this.pane.addFolder({
    ...
    const temporalResolveFolder = this.pane.addFolder({
    ...
    const blurFolder = this.pane.addFolder({ title: "Blur" });
    ...
    const jitterFolder = this.pane.addFolder({ title: "Jitter" });
    ...
    const definesFolder = this.pane.addFolder({ title: "Tracing" });
    ...
    const resolutionFolder = this.pane.addFolder({
      title: "Resolution",
      expanded: false,
    });
